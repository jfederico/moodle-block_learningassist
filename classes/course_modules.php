...
class course_modules {
    ...
    public static function set_module_content(int $id, string $name, string $intro, string $content, string $module_type): string
    {
        ...
        global $CFG;
        require_once($CFG->dirroot . '/blocks/learningassist/vendor/autoload.php');

        if (!class_exists('\League\HTMLToMarkdown\HtmlConverter')) {
            throw new \moodle_exception('HtmlConverter class not found. Please ensure html2markdown is installed via Composer.');
        }
